...
def test_register_builtin_providers() -> None:
    ...
    assert reg.has("embedder", "fake_alt")
    ...
    assert isinstance(reg.create("llm", "fake"), FakeLLM)
    ...
    assert isinstance(reg.create("reranker", "noop"), NoopReranker)

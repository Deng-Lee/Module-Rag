...
- 帮我生成项目 highlight
- 帮我提炼这个项目的亮点
- 阅读 `DEV_SPEC.md` 生成 highlight
- 结合 `dev_spec.md` 输出项目亮点
- 根据项目方案文档整理简历亮点
- 按大模型开发工程师 / Agent 工程师方向提炼项目卖点

若用户同时要求“生成简历项目描述 / 项目经历 / 亮点话术”，也应优先使用本 skill 先从 `DEV_SPEC.md` 中提炼亮点，再组织输出。

## 概览

从 `DEV_SPEC.md` 中抽取 10 个具体可落地的项目亮点，按固定结构写入 `PROJECT_HIGHLIGHTS.md`：亮点标题、技术要点、简历话术方向。强调实现细节，避免名词堆砌。
